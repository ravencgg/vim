...
syn keyword cType uint8 uint16 uint32 uint64 int8 int16 int32 int64 bool32 b32
syn keyword cType u8 u16 u32 u64 s8 s16 s32 s64 f32 f64
syn keyword cType v2 v3 v4 m3 m4
...
if exists("g:c_function_highlight")
    ...
    syn keyword cDefine NO_DISCARD BIT Defer VALIDATE VALIDATE_V countof arrsize assert ASSERT VERIFY REF
    syn keyword cDefine META_FIELD META_STRUCT META_ENUM INVALID_INDEX CVAR countof arrsize assert
